...
export const pageMetadata = {
  ...
  '/pricing': {
    title: 'Pricing — Transparent AI Automation Solutions',
    description: 'See all pricing tiers for logistics automation, website development, chatbots, AI automation, and AI agents.',
    image: 'https://xaivon.com/og-image.png',
  },
  '/contact': {
    title: 'Contact XAIVON — Schedule Your Strategy Call',
    description: 'Get in touch with XAIVON. Schedule a 30-min call to discuss your AI automation needs.',
    image: 'https://xaivon.com/og-image.png',
  },
  '/blog': {
    title: 'Blog — AI Automation Insights & Guides',
    description: 'Read case studies, guides, and insights on AI automation, logistics, and business infrastructure.',
    image: 'https://xaivon.com/og-image.png',
  },
  '/resources': {
    title: 'Resources — AI Automation Tools & Guides',
    description: 'Free guides, checklists, and resources for implementing AI automation in your business.',
    image: 'https://xaivon.com/og-image.png',
  },
  '/privacy-policy': {
